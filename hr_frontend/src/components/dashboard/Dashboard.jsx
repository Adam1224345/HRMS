...
// --- MODERN & RESPONSIVE NOTIFICATION BELL ---
const NotificationBell = ({ userId, userRoles }) => {
  ...
  useEffect(() => {
    ...
    const socket = io(SOCKET_BASE, {
      withCredentials: true, transports: ['websocket'], reconnection: true, reconnectionAttempts: 5
    });

    socket.on('connect', () => socket.emit('join', { user_id: userId, is_admin_or_hr: isAdminOrHR }));
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {open && (
        ...
        >
          {/* Header with Blue Gradient Touch */}
  ...
  return (
    <SidebarProvider>
      ...
      <SidebarInset className="bg-background flex flex-col min-h-screen">
        {/* Sticky Header with Blue Elements */}
