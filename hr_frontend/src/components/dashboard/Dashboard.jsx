...
const Dashboard = () => {
      ...
      default:
        return (
          <div className="space-y-6">
            <div>
              <h2 className="text-3xl font-bold text-gray-900">Welcome back, {user?.first_name || 'User'}!</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold text-green-600">{user?.is_active ? 'Active' : 'Inactive'}</div>
                  <p className="text-xs text-muted-foreground">
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      ...
      {/* Sidebar */}
      <div className={`fixed top-0 left-0 z-50 w-64 h-full bg-white shadow-lg transform ${
